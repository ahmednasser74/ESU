...
class AvailableCourseItemWidget extends StatelessWidget {
  const AvailableCourseItemWidget({
    Key? key,
    required this.course,
    required this.onTapAddCourse,
  }) : super(key: key);
  final CourseItemResponseModel course;
  final VoidCallback onTapAddCourse;
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 8.h),
                AppButton(
                  onPressed: onTapAddCourse,
                  title: LocalizationKeys.addCourse.tr,
                  paddingVertical: 0,
                  fonSize: 12.sp,
                )
              ],
